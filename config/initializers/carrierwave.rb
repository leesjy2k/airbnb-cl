...
CarrierWave.configure do |config|
  config.fog_credentials = {
      :provider               => 'AWS',
      :aws_access_key_id      => ENV['S3_KEY_ID'],#security credentials of my created user "ABC" under my AWS account
  ...
  config.fog_directory  = "pairbnb-lsj" #bucket name, for eg. : "my_pairbnb"
end